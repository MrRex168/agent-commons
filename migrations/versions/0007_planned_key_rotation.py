...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("root_public_key_multibase", sa.String(length=128), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("new_public_key_multibase", sa.String(length=128), nullable=False),
        sa.Column("payload", sa.Text(), nullable=False),
        sa.Column("previous_signature_multibase", sa.String(length=256), nullable=False),
        sa.Column("new_signature_multibase", sa.String(length=256), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(["agent_id"], ["agents.id"]),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("agent_id", "sequence", name="uq_agent_key_transition_sequence"),
    )
    op.create_index(
...
def downgrade() -> None:
    op.drop_index("ix_agent_key_transitions_agent_id", table_name="agent_key_transitions")
