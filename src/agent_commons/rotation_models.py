...
class AgentIdentityKeyState(Base):
    ...
    root_public_key_multibase: Mapped[str] = mapped_column(
        String(128),
        nullable=False,
    )
    root_fingerprint: Mapped[str] = mapped_column(
        String(80),
        nullable=False,
        index=True,
    )
    current_public_key_multibase: Mapped[str] = mapped_column(
        String(128),
        nullable=False,
    )
...
class AgentKeyRotationChallenge(Base):
    ...
    previous_public_key_multibase: Mapped[str] = mapped_column(
        String(128),
        nullable=False,
    )
    new_public_key_multibase: Mapped[str] = mapped_column(
        String(128),
        nullable=False,
    )
...
class AgentKeyTransition(Base):
    ...
    payload: Mapped[str] = mapped_column(Text, nullable=False)
    previous_signature_multibase: Mapped[str] = mapped_column(
        String(256),
        nullable=False,
    )
    new_signature_multibase: Mapped[str] = mapped_column(
        String(256),
        nullable=False,
    )
